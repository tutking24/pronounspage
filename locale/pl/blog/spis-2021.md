...
![](/img-local/spis-2021/zaimki-grupy.png)
...
<details class="border mb-3">
    ...
    <div class="p-3 border-top">
        <p class="h5">Neozaimki</p>
        <ul>
            <li>wona/wej ("wona jest fajna", "lubię wej zwierzątko")</li>
            <li>ona/wej</li>
            <li>wona/jiji</li>
            <li>onu jest fajna, lubię jej zwierzątko</li>
            <li>Ne/nego ("ne jest fajne", "lubię nego zwierzątko")</li>
            <li>nya/nyan ("nya jest fajnya", "lubię nyan zwierzątko")</li> 
            <li>Nya/nyich ("nya są fajni" "lubię nyich zwierzątko")</li>
            <li>onu/jegu ("onu jest fajnu", "lubię jegu zwierzątko") (2)</li>
            <li>nor/mal ("nor jest fajno","lubię mal zwierzątko ")</li>
            <li>en/ego ("en jest fajne", "lubię ego zwierzątko")</li>
            <li>vi/vej ("vi jest fajne", "lubie vej zwierzątko")</li>
            <li>om/o</li>
            <li>veno</li>
            <li>xe/xego</li>
            <li>miau/mrr</li>
            <li>miau/miaugo (miau jest fajne, lubię miaugo zwierzątko)</li>
            <li>Szczeniak jest fajny/ lubię szczeniaka zwierzątko</li>
            <li>void/void</li>
            <li>Onaj/onejch</li>
            <li>To/tego</li>
            <li>ona/jego (5)</li>
            ...
            <li>on/ich (3)</li>
            <li>ona/ich</li>
            <li>one/ich (one jest fajne, lubię ich zwierzątko)</li>
        </ul>
        <p class="h5">Znaki zastępujące</p>
        <ul>
            <li>on_/je_ (2)</li>
            <li>x/jexx ("x jest fajnx, lubię jexx zwierzątko")</li>
            <li>onx/jejgo</li>
            <li>onx/ich (2)</li>
            <li>onx/jex (3)</li>
            <li>onx/jexx(1)</li>
            <li>onx są fajnx lubię x zwierzątko</li>
            <li>zonx/jexx</li>
            <li>Onæ/jæ</li>
            <li>on@/jej</li>
            <li>Onå/onåy</li>
            <li>onä/onäy</li>
            <li>ono/jen</li>
            <li>ono/ich (ono jest fajne, lubię ich zwierzątko) (12)</li>
            <li>ono/ich "ono jest fajno, lubię ich zwierzątko"</li>
            <li>ono/onego (2)</li>
            <li>ono jest fajn</li>
        </ul>
    </div>
...
- **MLA**: Vos, Andrea, Szymon Misiek, Paweł Dembowski i Tymoteusz Lisowski. 2021. „Niebinarny Spis Powszechny 2021 – wnioski.” _Zaimki.pl_. Kolektyw „Rada Języka Neutralnego.” \[publikacja internetowa] https://zaimki.pl/blog/spis-2022
- **APA**: Vos. Andrea, Szymon Misiek, Paweł Dembowski i Tymoteusz Lisowski (2021) „Niebinarny Spis Powszechny 2021 – wnioski.” _Zaimki.pl_. Kolektyw „Rada Języka Neutralnego.” https://zaimki.pl/blog/spis-2021
- **Chicago**: Vos, Andrea, Szymon Misiek, Paweł Dembowski i Tymoteusz Lisowski. „Niebinarny Spis Powszechny 2021 – wnioski.” _Zaimki.pl_, Kolektyw „Rada Języka Neutralnego”, 2021, https://zaimki.pl/blog/spis-2021

{/details}

 - Post [Miłość Nie Wyklucza](https://www.facebook.com/Miloscniewyklucza/posts/4234693629884558)
 - Newsletter  [wlasny$pokój](https://www.wlasnyspokoj.net/) z 30 marca 2021
