...
module.exports = [
    ...
    new Event('{https://en.wikipedia.org/wiki/2022_Oslo_shooting=2022 Oslo Pride Shooting} Remembrance Day', '_black-ribbon', 6, day(25), EventLevel.Day),
    new Event('{https://en.wikipedia.org/wiki/2022_Bratislava_shooting=2022 Bratislava Shooting} Remembrance Day', '_black-ribbon', 10, day(12), EventLevel.Day),
