...
module.exports = [
    ...
    new Event('Día de la Prueba del VIH (EE.UU./Argentina)', null, 6, day(27), EventLevel.Day),
        new Event('Día de la Prueba del VIH (España)', null, 10, day(20), EventLevel.Day),
    ...
    new Event('Día del VIH/SIDA (Uruguay)', null, 7, day(29), EventLevel.Day,
