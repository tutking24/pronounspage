...
module.exports = [
    ...
    new Event('{/terminology#nonbinary=Nonbinary} Kids\' Day', 'Nonbinary', 10, day(1), EventLevel.Day, ['nonbinary']),
    new Event('{https://en.wikipedia.org/wiki/David_Kato=Kuchu Remembrance Day}', '_black-ribbon', 1, day(26), EventLevel.Day),
