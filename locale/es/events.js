...
module.exports = [
    ...
    new Event('Día  Nacional de la Prueba del VIH (España)', null, 10, day(20), EventLevel.Day, ['aids']),
    new Event('Día  Nacional de la Prueba del VIH (México)', null, 11, day(23), EventLevel.Day, ['aids']),
    new Event('Día  Nacional de la Prueba del VIH (Perú)', null, 6, day(10), EventLevel.Day, ['aids']),
    new Event('Día de Concientización sobre el VIH/SIDA entre las Personas de Raza Negra (EE.UU.)', null, 2, day(7), EventLevel.Day, ['aids']),
    new Event('Día de Concientización sobre el VIH/SIDA entre los Hombres Gais (EE.UU.)', null, 9, day(27), EventLevel.Day, ['aids', 'gay']),
    new Event('Día de Concientización sobre el VIH/SIDA y el Envejecimiento (EE.UU.)', null, 9, day(18), EventLevel.Day, ['aids']),
    new Event('Día de la Conciencia de los Centros de la Comunidad LGBT (EE.UU.)', null, 10, day(19), EventLevel.Day),
    new Event('Día Latinx para la Concientización del SIDA (EE.UU.)', null, 10, day(15), EventLevel.Day, ['aids']),
    new Event('Día de Concientización sobre el VIH/SIDA entre los Jóvenes (EE.UU.)', null, 4, day(10), EventLevel.Day, ['aids']),
    new Event('Día de Concientización sobre el VIH/SIDA entre las Mujeres y Niñas (EE.UU.)', null, 3, day(10), EventLevel.Day, ['aids']),
    new Event('Día de Concientización para los Sobrevivientes a Largo Plazo del VIH (EE.UU.)', null, 6, day(5), EventLevel.Day, ['aids']),
    ...
    new Event('Día Nacional de lucha contra el VIH/SIDA (Uruguay)', null, 7, day(29), EventLevel.Day, ['aids']),
